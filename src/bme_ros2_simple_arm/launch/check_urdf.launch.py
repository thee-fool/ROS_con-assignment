...
def generate_launch_description():
    ...
    pkg_bme_ros2_simple_arm = FindPackageShare('bme_ros2_simple_arm')
    default_rviz_config_path = PathJoinSubstitution([pkg_bme_ros2_simple_arm, 'rviz', 'urdf.rviz'])
    ...
    # URDF model path within the bme_ros2_simple_arm package
    ...
    urdf = IncludeLaunchDescription(
        ...
        launch_arguments={
            'urdf_package': 'bme_ros2_simple_arm',
